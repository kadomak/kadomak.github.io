...
---
Hi, I’m Kowe (co-weh)! **I am currently seeking full-time opportunities in industry as a Research Scientist, UX Researcher, or Data Scientist in Responsible AI!** As a final year PhD candidate at Cornell Tech in the [Social Technologies Lab](https://s.tech.cornell.edu/), I develop evaluation frameworks to characterize new harms in AI systems and design interventions to create safe, trustworthy, and inclusive AI. In my work, I use mixed methods approaches from human-computer interaction (HCI) and evaluation methods from natural language processing (NLP). Broadly speaking, my research falls under responsible AI (RAI). My work has been supported by The National GEM Consortium, Cornell’s Digital Life Initiative, and LinkedIn. I am also a member in Cornell's [AI Policy and Practice](https://aipp.cis.cornell.edu/) group and [CTRL-ALT](https://www.dli.tech.cornell.edu/ctrl-alt) group.
